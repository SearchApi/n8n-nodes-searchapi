...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    default: {},
    options: [
      nextPageToken('Next page token used to retrieve the next page of photos. If there are no results for the given token, the response will include only search parameters and search metadata.')
    ],
    displayOptions,
  },
