...
const properties: INodeProperties[] = [
	{
		...
		required: true,
		default: '',
		description: 'YouTube video ID to retrieve comments from',
		options: [],
		displayOptions,
		routing: {
			request: {
	...
	},
	{
		...
		type: 'collection',
		placeholder: 'Add Localization Setting',
		default: {},
		options: [
			{
				displayName: 'Country',
				...
				type: 'options',
				default: 'US',
				description: 'Country code (ISO 3166-1 alpha-2) for localizing results',
				options: [
			...
			},
			{
				...
				type: 'options',
				default: 'en',
				description: 'Language code for the user interface',
				options: [
					...
					{ name: 'English (Australia)', value: 'en-gb' },
		...
		options: [
			{
				...
				default: '',
				description: 'Token for retrieving the next page of comments or replies',
				options: [],
				routing: {
					request: {
						qs: {
